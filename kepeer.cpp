...
Keeper::Keeper() {
    head = nullptr;
    _size = 0;
    cout << "[Был запущен конструктор Keeper]" << std::endl;
    cout << std::endl;
}
...
Keeper::Keeper(int size) {
    head = nullptr;
    _size = size;
    std::cout << "[Был запущен конструктор Keeper(c параметром)]" << std::endl;
    std::cout << std::endl;
}
                    ...
                    if (item == "Car" || item == "Train" || item == "Plane") {
                        ...
                        if (item == "Car") {
                            ...
                            do {
                                ...
                                if (item == "Car" || item == "Train" || item == "Plane" || fileIn.eof()) {
                                    Car* car;
                                    car = new Car(mark, model, yearCar, valumeCar);
                                    carrier = car;
                                    pushObject(carrier);
                                    counterObject++;
                                    break;
                        ...
                        if (item == "Train") {
                            ...
                            do {
                                ...
                                if (item[0] == 'v' && item[1] == 'a' && item[2] == 'l' && item[3] == 'u'
